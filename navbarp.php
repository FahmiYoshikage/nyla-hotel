      ...
      <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
        ...
        <li class="nav-item">
          ...
          <ul id="masterMenu" class="nav flex-column dropdown-content" style="display: none; margin-left: 20px;">
            <li class="nav-item">
              <a href="pelangganp.php" class="nav-link"><p>Pelanggan</p></a>
            </li>
            <li class="nav-item">
              <a href="pemesananp.php" class="nav-link"><p>pemesanan</p></a>
            </li>
        ...
        <li class="nav-item">
          ...
          <ul id="laporanMenu" class="nav flex-column dropdown-content" style="display: none; margin-left: 25px;">
            <li class="nav-item"><a href="lap_pemesananp.php" class="nav-link"><p>Pemesanan</p></a></li>
           
          </ul>
        </li>
 <li class="nav-item">
              <a href="feedback.php" class="nav-link"><p>feedback
              </p></a>
            </li>
        <!-- TRANSAKSI -->
